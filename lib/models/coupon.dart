class Coupon {
  ...
  Coupon.fromJson(Map<String, dynamic> json) {
    ...
    applicableProduct = json['applicableProduct'] != null
        ...
        : null;
    applicableEvent = json['applicableEvent'] != null
        ? new CatRef.fromJson(json['applicableEvent'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.applicableEvent != null) {
      data['applicableEvent'] = this.applicableEvent!.toJson();
    }
