...
class ProductSubmitForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    context.read<DashBoardProvider>().setDataForUpdateProduct(product);
    return SingleChildScrollView(
      child: Form(
        key: context.read<DashBoardProvider>().addProductFormKey,
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: defaultPadding),
              CustomTextField(
                controller: context.read<DashBoardProvider>().productNameCtrl,
              ...
              SizedBox(height: defaultPadding),
              CustomTextField(
                controller: context.read<DashBoardProvider>().productDescCtrl,
                ...
                children: [
                  Expanded(
                    child: CustomTextField(
                      controller:
                          context.read<DashBoardProvider>().productPriceCtrl,
                      labelText: 'Price',
                  ...
                  Expanded(
                    child: CustomTextField(
                      controller:
                          context.read<DashBoardProvider>().productOffPriceCtrl,
                  ...
                  Expanded(
                    child: CustomTextField(
                      controller:
                          context.read<DashBoardProvider>().productQntCtrl,
                      labelText: 'Quantity',
                      inputType: TextInputType.number,
                      onSave: (val) {},
                      validator: (value) {
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (form != null && form.validate()) {
                        form.save();
                        context.read<DashBoardProvider>().submitProduct();
